<template>
	<aby-page>
		...
		<div class="mui-content" slot="content">
			<mt-field placeholder="请输入您遇到的问题和宝贵建议（500字以内）" modelId="adviceDesc" class="contact" type="textarea" rows="5"></mt-field>
			<div class="space"></div>
			<mt-field class="contact" placeholder="请输入您的联系方式（选填，便于我们联系您）" modelId="contactPhone" type="tel"></mt-field>
